...
confirming our analysis.  
  ...
  Additionally, the average execution time of the old algorithm here is slightly higher than the results in Figure~\ref{fig:exp-time} in Section~\section{sec:mrf1}. 
