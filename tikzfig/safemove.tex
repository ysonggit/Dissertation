 ...
 \begin{tikzpicture}[scale=0.6]
    ...
    \node[color=blue] at (4.875+\offset, 2.75-\offset) {$r_p$};
    \draw[fill=green] (3+\dddx,2.92) -- (2.5+\dddx,2.75) -- (3+\dddx,2.58) -- (2.875+\dddx,2.75) -- cycle;
    \node[color=blue] at (7.375, 2.75-\offset) {$r_c$};
    \draw[dotted] (I) -- (S);
    \draw[dotted] (I) -- (C);
...
\begin{flushright}
   \begin{tikzpicture}[scale=0.6]
    ...
    \node[color=blue] at (4.875+\offset, 2.75-\offset) {$r_p$};
    \draw[fill=green] (3+\dddx,2.92) -- (2.5+\dddx,2.75) -- (3+\dddx,2.58) -- (2.875+\dddx,2.75) -- cycle;
    \node[color=blue] at (5.875+\offset, 2.75-\offset) {$r_c$};
    \draw[dotted] (I) -- (S);
    \draw[dotted] (I) -- (C);
